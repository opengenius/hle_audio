...
void ClickInteractionUpdate(ImNodesEditorContext& editor)
{
    ...
    case ImNodesClickInteractionType_Node:
    {
        ...
        {
            editor.ClickInteraction.Type = ImNodesClickInteractionType_None;
            // <--- HLEA: drag stop event
            GImNodes->ImNodesUIState |= ImNodesUIState_NodeDragStopped;
            // --->
        }
    }
    break;
...
// <--- HLEA: drag stop event
bool IsNodesDragStopped()
{
    return (GImNodes->ImNodesUIState & ImNodesUIState_NodeDragStopped) != 0;
}
// --->
